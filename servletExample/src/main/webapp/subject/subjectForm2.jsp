		...
		<form name = "subject" id="subject">
			...
			<tbody>
				<tr>
					...
					<td><input type="text" name="s_num" id="s_num" /></td>
        			
    				
					<p>기존에 있는 학과번호 중에서 select할 수 있게 만들고 학과명은 readonly로 출력되게 하자 너가</p>
				</tr>
				<tr>
					<th class="ls7">학과명</th>
					<td><input type="text" name="s_name" id="s_name" maxlength="8"readonly = "readonly"/></td>
				</tr>
				<tr>
					<td colspan="2" class = "text - center">
						<button type="button" id="deleteBtn" >삭제완료</button>
